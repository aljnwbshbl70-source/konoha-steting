...
// 1. خدمة الـ Uptime لمنع وضع الغفوة واستقبال كلمة OK كل دقيقتين
const app = express();
app.get('/uptime', (req, res) => { res.send('OK'); });
const PORT = process.env.PORT || 3000;
app.listen(PORT, () => console.log(`🔒 الحارس المركزي شغال على منفذ: ${PORT}`));
